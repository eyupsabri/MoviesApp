    ...
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Category>().HasData(
                ...
                new { Id = 7, MovieCategory = MovieCategoryOptions.Animation },
                new { Id = 8, MovieCategory = MovieCategoryOptions.SciFi },
                new { Id = 9, MovieCategory = MovieCategoryOptions.Sport },
                new { Id = 10, MovieCategory = MovieCategoryOptions.Action },
                new { Id = 11, MovieCategory = MovieCategoryOptions.Thriller },
                new { Id = 12, MovieCategory = MovieCategoryOptions.Mystery },
                new { Id = 13, MovieCategory = MovieCategoryOptions.Western },
                new { Id = 14, MovieCategory = MovieCategoryOptions.Romance },
                new { Id = 15, MovieCategory = MovieCategoryOptions.Biography },
                new { Id = 16, MovieCategory = MovieCategoryOptions.Horror },
                new { Id = 17, MovieCategory = MovieCategoryOptions.War },
                new { Id = 18, MovieCategory = MovieCategoryOptions.Musical },
                new { Id = 19, MovieCategory = MovieCategoryOptions.History },
                new { Id = 20, MovieCategory = MovieCategoryOptions.Music },
                new { Id = 21, MovieCategory = MovieCategoryOptions.Documentary },
                new { Id = 22, MovieCategory = MovieCategoryOptions.Short },
                new { Id = 23, MovieCategory = MovieCategoryOptions.TalkShow },
                new { Id = 24, MovieCategory = MovieCategoryOptions.GameShow },
                new { Id = 25, MovieCategory = MovieCategoryOptions.RealityTV },
                new { Id = 26, MovieCategory = MovieCategoryOptions.News },
                new { Id = 27, MovieCategory = MovieCategoryOptions.Adult }
                );
            ...
            modelBuilder.Entity<User>().HasData(
                new User { Id = 1, Name = "Hüsnü Cemre", Email = "husnu.cemre@gmail.com", Password = "123Abc.", NickName = "trc10", BirthDate = new DateTime(1992, 12, 14), IsAdmin = true }
            );
        }
